...
@attached(member, names: named(jsonEncoder), named(jsonDecoder), named(encode), named(decode), named(create), named(customEncoding), named(customDecoding), named(init))
...
/// 如果你的变量名和 API 对不上，可以使用 @Param 对其进行修改。例如：@Param("userId")
@attached(peer)
